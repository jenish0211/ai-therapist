                            ...
                            >
                                                ...
                                                {day.activities.map((activity, i) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <div
                                                                className={`h-1.5 w-1.5 rounded-full ${activity.impact === "positive"
                                                                    ? "bg-green-500"
                                ...
                                <div className="relative w-12 cursor-pointer">
                                    <motion.div
                                        ...
                                        className={`w-8 rounded-full bg-gradient-to-t from-primary/20 to-primary/30 group-hover:from-primary/30 group-hover:to-primary/40 transition-all absolute bottom-0 left-1/2 -translate-x-1/2 ${selectedDay === index ? "ring-2 ring-primary" : ""
                                            }`}
                                    >
                                ...
                                <span
                                    className={`text-sm font-medium transition-colors ${selectedDay === index
                                        ? "text-primary"
